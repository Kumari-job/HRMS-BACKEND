...
class EmployeeController extends Controller
{
    ...
    {
        $employee = Employee::with(['employeeAddress','employeeBenefit','employeeContracts','employeeDocument','employeeEducations','employeeExperiences','employeeFamilies','employeeOnboardings'])->find($id);
